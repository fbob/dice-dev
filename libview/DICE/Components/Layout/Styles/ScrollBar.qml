...
Rectangle {
    ...
    implicitWidth: styleData.horizontal ? 300 :10
    implicitHeight: styleData.horizontal ? 10 : 300
    color: "transparent"
    ...
    Rectangle {
        id: __barFill
        anchors.fill: parent
        anchors.leftMargin: styleData.horizontal ? 0 : 0.5 * (1 - percentWidth) * 10
        anchors.rightMargin: styleData.horizontal ? 0 : 0.5 * (1 - percentWidth) * 10
        anchors.topMargin: styleData.horizontal ? 0.5 * (1 - percentWidth) * 10 : 0
        anchors.bottomMargin: styleData.horizontal ? 0.5 * (1 - percentWidth) * 10 : 0
        color: "red"
        radius: width/2
    }
